---
title: "Magical Footgolf Challenge Round 1 Statistics"
author: "Sep Dadsetan"
date: 2018-09-02
output: html_document
categories: ["Sports", "Footgolf"]
tags: ["r-markdown", "footgolf", "afgl"]
image: "img/magical.jpg"
---
...
# Read data
scores_men <- read_csv("../../rdata/footgolf/disney/disney_scores_men.csv", col_types = c("ciiiii"), col_names = T)
scores_women <- read_csv("../../rdata/footgolf/disney/disney_scores_women.csv", col_types = c("ciiiii"), col_names = T)
scores_seniors <- read_csv("../../rdata/footgolf/disney/disney_scores_seniors.csv", col_types = c("ciiiii"), col_names = T)
